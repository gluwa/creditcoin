...
import type { CreditcoinNodeRuntimeOpaqueSessionKeys, CreditcoinNodeRuntimeOriginCaller, PalletCreditcoinAskOrderId, PalletCreditcoinBidOrderId, PalletCreditcoinBlockchain, PalletCreditcoinDealOrderId, PalletCreditcoinLoanTerms, PalletCreditcoinOcwErrorsVerificationFailureCause, PalletCreditcoinOcwTasksCollectCoinsGCreContract, PalletCreditcoinOfferId, PalletCreditcoinSignatureType, PalletCreditcoinTaskId, PalletCreditcoinTaskOutput, PalletCreditcoinTransferKind, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletNominationPoolsBondExtra, PalletNominationPoolsClaimPermission, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsConfigOpAccountId32, PalletNominationPoolsConfigOpPerbill, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsPoolState, PalletStakingPalletConfigOpPerbill, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingRewardDestination, PalletStakingValidatorPrefs, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusGrandpaEquivocationProof, SpConsensusSlotsEquivocationProof, SpCoreEcdsaPublic, SpCoreEcdsaSignature, SpRuntimeMultiSignature, SpRuntimeMultiSigner, SpSessionMembershipProof, SpWeightsWeightV2Weight } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    creditcoin: {
      ...
      offchainAddress: AugmentedSubmittable<(blockchain: PalletCreditcoinBlockchain | { Ethereum: any } | { Rinkeby: any } | { Luniverse: any } | { Bitcoin: any } | { Other: any } | string | Uint8Array, address: Bytes | string | Uint8Array, ownershipProof: SpCoreEcdsaSignature | string | Uint8Array, signatureType: PalletCreditcoinSignatureType | 'PersonalSign' | 'EthSign' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletCreditcoinBlockchain, Bytes, SpCoreEcdsaSignature, PalletCreditcoinSignatureType]>;
      ...
      setCollectCoinsContract: AugmentedSubmittable<(contract: PalletCreditcoinOcwTasksCollectCoinsGCreContract | { address?: any; chain?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletCreditcoinOcwTasksCollectCoinsGCreContract]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
