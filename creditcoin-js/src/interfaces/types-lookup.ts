...
declare module '@polkadot/types/lookup' {
  ...
  export interface PalletCreditcoinCall extends Enum {
    ...
    readonly type: 'ClaimLegacyWallet' | 'RegisterAddress' | 'AddAskOrder' | 'AddBidOrder' | 'AddOffer' | 'AddDealOrder' | 'LockDealOrder' | 'FundDealOrder' | 'RegisterDealOrder' | 'CloseDealOrder' | 'RequestCollectCoins' | 'RegisterFundingTransfer' | 'RegisterRepaymentTransfer' | 'Exempt' | 'PersistCollectCoins' | 'VerifyTransfer' | 'FailTransfer' | 'FailCollectCoins' | 'AddAuthority';
  }
  ...
  /** @name PalletCreditcoinUnverifiedTransfer (131) */
  ...
  /** @name PalletCreditcoinError (134) */
  ...
  /** @name PalletDifficultyDifficultyAndTimestamp (136) */
  export interface PalletDifficultyDifficultyAndTimestamp extends Struct {
    readonly difficulty: U256;
    readonly timestamp: u64;
  }

  /** @name PalletDifficultyError (138) */
  ...
  /** @name CreditcoinNodeRuntimeRuntime (149) */
