...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletCreditcoinCall extends Enum {
    ...
    readonly isOffchainAddress: boolean;
    readonly asOffchainAddress: {
      readonly blockchain: PalletCreditcoinBlockchain;
      readonly address: Bytes;
      readonly ownershipProof: SpCoreEcdsaSignature;
      readonly signatureType: PalletCreditcoinSignatureType;
    } & Struct;
    readonly type: 'ClaimLegacyWallet' | 'RegisterAddress' | 'AddAskOrder' | 'AddBidOrder' | 'AddOffer' | 'AddDealOrder' | 'LockDealOrder' | 'FundDealOrder' | 'RegisterDealOrder' | 'CloseDealOrder' | 'RequestCollectCoins' | 'RegisterFundingTransfer' | 'RegisterRepaymentTransfer' | 'Exempt' | 'PersistTaskOutput' | 'FailTask' | 'AddAuthority' | 'SetCollectCoinsContract' | 'RemoveAuthority' | 'OffchainAddress';
  }
  ...
  /** @name CreditcoinNodeRuntimeOriginCaller (315) */
  ...
  /** @name FrameSupportDispatchRawOrigin (316) */
  ...
  /** @name PalletFastUnstakeCall (320) */
  ...
  /** @name PalletNominationPoolsCall (321) */
  ...
  /** @name PalletNominationPoolsBondExtra (322) */
  ...
  /** @name PalletNominationPoolsConfigOpU128 (323) */
  ...
  /** @name PalletNominationPoolsConfigOpU32 (324) */
  ...
  /** @name PalletNominationPoolsConfigOpPerbill (325) */
  ...
  /** @name PalletNominationPoolsConfigOpAccountId32 (326) */
  ...
  /** @name PalletNominationPoolsClaimPermission (327) */
  ...
  /** @name PalletSudoError (328) */
  interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name PalletCreditcoinError (330) */
  ...
  /** @name PalletDifficultyError (335) */
  ...
  /** @name PalletSchedulerScheduled (338) */
  ...
  /** @name FrameSupportPreimagesBounded (339) */
  ...
  /** @name PalletCreditcoinTransferUnverifiedTransfer (344) */
  ...
  /** @name PalletOffchainTaskSchedulerError (345) */
  ...
  /** @name PalletIdentityRegistration (346) */
  ...
  /** @name PalletIdentityRegistrarInfo (354) */
  ...
  /** @name PalletFastUnstakeUnstakeRequest (367) */
  ...
  /** @name PalletFastUnstakeError (370) */
  ...
  /** @name PalletNominationPoolsPoolMember (371) */
  ...
  /** @name PalletNominationPoolsBondedPoolInner (376) */
  ...
  /** @name PalletNominationPoolsCommission (377) */
  ...
  /** @name PalletNominationPoolsPoolRoles (380) */
  ...
  /** @name PalletNominationPoolsRewardPool (381) */
  ...
  /** @name FrameSupportPalletId (389) */
  interface FrameSupportPalletId extends U8aFixed {}

  /** @name PalletNominationPoolsError (390) */
  ...
  /** @name PalletNominationPoolsDefensiveError (391) */
  ...
  /** @name FrameSystemExtensionsCheckNonZeroSender (394) */
  ...
  /** @name CreditcoinNodeRuntimeRuntime (403) */
