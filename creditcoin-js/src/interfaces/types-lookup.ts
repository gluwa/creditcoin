...
declare module '@polkadot/types/lookup' {
    ...
    /** @name PalletChaosEvent (82) */
    interface PalletChaosEvent extends Enum {
        readonly isStalled: boolean;
        readonly asStalled: ITuple<[u64, AccountId32]>;
        readonly isAdded: boolean;
        readonly asAdded: ITuple<[u32, AccountId32]>;
        readonly isCleared: boolean;
        readonly asCleared: AccountId32;
        readonly type: 'Stalled' | 'Added' | 'Cleared';
    }
    ...
    /** @name PalletChaosCall (147) */
    interface PalletChaosCall extends Enum {
        readonly isOverflowAdder: boolean;
        readonly asOverflowAdder: {
            readonly n: u32;
        } & Struct;
        readonly isClearAdder: boolean;
        readonly isDragBlockUnitWeight: boolean;
        readonly asDragBlockUnitWeight: {
            readonly n: u64;
        } & Struct;
        readonly type: 'OverflowAdder' | 'ClearAdder' | 'DragBlockUnitWeight';
    }
    ...
    /** @name PalletCreditcoinUnverifiedTransfer (151) */
    ...
    /** @name PalletSchedulerScheduledV3 (161) */
    ...
    /** @name CreditcoinNodeRuntimeOriginCaller (162) */
    ...
    /** @name PalletSchedulerReleases (165) */
    ...
    /** @name PalletChaosError (167) */
    interface PalletChaosError extends Enum {
        readonly isNoneValue: boolean;
        readonly isAdderOverflow: boolean;
        readonly type: 'NoneValue' | 'AdderOverflow';
    }

    /** @name FrameSystemExtensionsCheckSpecVersion (170) */
    type FrameSystemExtensionsCheckSpecVersion = Null;

    /** @name FrameSystemExtensionsCheckTxVersion (171) */
    type FrameSystemExtensionsCheckTxVersion = Null;

    /** @name FrameSystemExtensionsCheckGenesis (172) */
    type FrameSystemExtensionsCheckGenesis = Null;

    /** @name FrameSystemExtensionsCheckNonce (175) */
    interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

    /** @name FrameSystemExtensionsCheckWeight (176) */
    type FrameSystemExtensionsCheckWeight = Null;

    /** @name PalletTransactionPaymentChargeTransactionPayment (177) */
    interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

    /** @name CreditcoinNodeRuntimeRuntime (178) */
