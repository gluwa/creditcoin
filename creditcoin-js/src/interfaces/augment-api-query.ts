...
import type { FrameSupportWeightsPerDispatchClassU64, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReleases, PalletBalancesReserveData, PalletCreditcoinAddress, PalletCreditcoinAskOrder, PalletCreditcoinBidOrder, PalletCreditcoinCollectedCoins, PalletCreditcoinDealOrder, PalletCreditcoinLegacySighash, PalletCreditcoinOffer, PalletCreditcoinPlatformCurrency, PalletCreditcoinTask, PalletCreditcoinTaskId, PalletCreditcoinTransfer, PalletDifficultyDifficultyAndTimestamp, PalletTransactionPaymentReleases, SpRuntimeDigest } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    creditcoin: {
      ...
      collectedCoins: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<PalletCreditcoinCollectedCoins>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      currencies: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<PalletCreditcoinPlatformCurrency>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      ...
      pendingTasks: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: PalletCreditcoinTaskId | { VerifyTransfer: any } | { CollectCoins: any } | string | Uint8Array) => Observable<Option<PalletCreditcoinTask>>, [u32, PalletCreditcoinTaskId]> & QueryableStorageEntry<ApiType, [u32, PalletCreditcoinTaskId]>;
