...
export default {
  ...
  /**
   * Lookup127: pallet_difficulty::pallet::Call<T>
   **/
  ...
  /**
   * Lookup131: pallet_creditcoin::types::UnverifiedTransfer<sp_core::crypto::AccountId32, BlockNum, primitive_types::H256, Moment>
   **/
  ...
  /**
   * Lookup134: pallet_creditcoin::pallet::Error<T>
   **/
  ...
  /**
   * Lookup136: pallet_difficulty::DifficultyAndTimestamp<Moment>
   **/
  ...
  /**
   * Lookup138: pallet_difficulty::pallet::Error<T>
   **/
  ...
  /**
   * Lookup149: creditcoin_node_runtime::Runtime
   **/
