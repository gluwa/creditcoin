...
curl -L "https://github.com/gluwa/creditcoin/releases/download/$latest_release/creditcoin-v${latest_release}-x86_64-unknown-linux-gnu.tar"  --output creditcoin.tar && tar -xf creditcoin.tar || exit 1
chmod +x "$RELEASE_BIN"
