...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    creditcoin: {
      ...
      collectCoinsContract: AugmentedQuery<ApiType, () => Observable<PalletCreditcoinOcwTasksCollectCoinsGCreContract>, []> & QueryableStorageEntry<ApiType, []>;
