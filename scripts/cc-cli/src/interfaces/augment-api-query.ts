  ...
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    creditcoin: {
      addresses: AugmentedQuery<
        ...
        ) => Observable<Option<PalletCreditcoinAddress>>,
        [H256]
      > &
      ...
      collectedCoins: AugmentedQuery<
        ...
        (
          arg: H256 | string | Uint8Array,
        ) => Observable<Option<PalletCreditcoinCollectCoinsCollectedCoins>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      ...
      legacyWallets: AugmentedQuery<
        ApiType,
        (
          arg: PalletCreditcoinLegacySighash | string | Uint8Array,
      ...
      transfers: AugmentedQuery<
        ...
        (
          arg: H256 | string | Uint8Array,
        ) => Observable<Option<PalletCreditcoinTransfer>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
    ...
    difficulty: {
      currentDifficulty: AugmentedQuery<ApiType, () => Observable<U256>, []> &
        QueryableStorageEntry<ApiType, []>;
      difficultyAdjustmentPeriod: AugmentedQuery<
        ApiType,
        () => Observable<i64>,
        []
      > &
      ...
      > &
        QueryableStorageEntry<ApiType, []>;
      targetBlockTime: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    fastUnstake: {
      ...
      head: AugmentedQuery<
        ApiType,
        () => Observable<Option<PalletFastUnstakeUnstakeRequest>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    posSwitch: {
      switchBlockNumber: AugmentedQuery<
        ApiType,
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<CreditcoinNodeRuntimeOpaqueSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<
          Vec<ITuple<[AccountId32, CreditcoinNodeRuntimeOpaqueSessionKeys]>>
        >,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
