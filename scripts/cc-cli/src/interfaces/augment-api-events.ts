...
declare module "@polkadot/api-base/types/events" {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    creditcoin: {
       ...
       **/
      AddressRegistered: AugmentedEvent<
        ApiType,
        [H256, PalletCreditcoinAddress]
      >;
      /**
       ...
       **/
      CollectedCoinsMinted: AugmentedEvent<
        ApiType,
       ...
       **/
      LegacyWalletClaimed: AugmentedEvent<
        ApiType,
       ...
       **/
      TransferRegistered: AugmentedEvent<
        ApiType,
        [H256, PalletCreditcoinTransfer]
      >;
      /**
