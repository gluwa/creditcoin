...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, u: u32, c: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 19_559_000
			.saturating_add((11_221_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 19_559_000
			.saturating_add((862_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 19_559_000
			.saturating_add((20_996_000 as Weight).saturating_mul(o as Weight))
			// Standard Error: 19_559_000
			.saturating_add((30_371_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 19_559_000
			.saturating_add((60_229_000 as Weight).saturating_mul(f as Weight))
			// Standard Error: 19_559_000
			.saturating_add((35_658_000 as Weight).saturating_mul(u as Weight))
			// Standard Error: 19_559_000
			.saturating_add((2_967_000 as Weight).saturating_mul(c as Weight))
