...
//! DATE: 2022-10-24, STEPS: `8`, REPEAT: 8, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, u: u32, c: u32, ) -> Weight {
		(21_520_679_000 as Weight)
			// Standard Error: 18_733_000
			.saturating_add((24_357_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 18_733_000
			.saturating_add((16_464_000 as Weight).saturating_mul(o as Weight))
			// Standard Error: 18_733_000
			.saturating_add((28_072_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 18_733_000
			.saturating_add((32_667_000 as Weight).saturating_mul(f as Weight))
