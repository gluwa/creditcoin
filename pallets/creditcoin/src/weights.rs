...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, u: u32, c: u32, ) -> Weight {
		(989_814_000 as Weight)
			// Standard Error: 19_311_000
			.saturating_add((989_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 19_311_000
			.saturating_add((25_209_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 19_311_000
			.saturating_add((36_717_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 19_311_000
			.saturating_add((39_835_000 as Weight).saturating_mul(f as Weight))
			// Standard Error: 19_311_000
			.saturating_add((1_145_000 as Weight).saturating_mul(c as Weight))
