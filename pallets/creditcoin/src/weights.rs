...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, u: u32, c: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 12_236_000
			.saturating_add((28_738_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 12_236_000
			.saturating_add((34_006_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 12_236_000
			.saturating_add((29_727_000 as Weight).saturating_mul(o as Weight))
			// Standard Error: 12_236_000
			.saturating_add((45_084_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 12_236_000
			.saturating_add((50_978_000 as Weight).saturating_mul(f as Weight))
			// Standard Error: 12_236_000
			.saturating_add((31_667_000 as Weight).saturating_mul(u as Weight))
			// Standard Error: 12_236_000
			.saturating_add((29_872_000 as Weight).saturating_mul(c as Weight))
