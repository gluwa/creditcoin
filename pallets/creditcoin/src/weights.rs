...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, u: u32, c: u32, ) -> Weight {
		(6_970_488_000 as Weight)
			// Standard Error: 23_286_000
			.saturating_add((52_294_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 23_286_000
			.saturating_add((67_485_000 as Weight).saturating_mul(f as Weight))
			// Standard Error: 23_286_000
			.saturating_add((35_814_000 as Weight).saturating_mul(c as Weight))
