...
//! DATE: 2023-01-05, STEPS: `8`, REPEAT: 8, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, u: u32, c: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((1_331_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 123_000
			.saturating_add((1_319_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 123_000
			.saturating_add((1_058_000 as Weight).saturating_mul(o as Weight))
			// Standard Error: 123_000
			.saturating_add((10_855_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 123_000
			.saturating_add((14_150_000 as Weight).saturating_mul(f as Weight))
			// Standard Error: 123_000
			.saturating_add((1_056_000 as Weight).saturating_mul(u as Weight))
			// Standard Error: 123_000
			.saturating_add((1_297_000 as Weight).saturating_mul(c as Weight))
