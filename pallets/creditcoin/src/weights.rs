...
//! DATE: 2022-05-13, STEPS: `8`, REPEAT: 8, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, _u: u32, ) -> Weight {
		(759_291_000 as Weight)
			// Standard Error: 360_000
			.saturating_add((1_343_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 360_000
			.saturating_add((1_400_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 1_450_000
			.saturating_add((7_297_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 2_901_000
			.saturating_add((3_882_000 as Weight).saturating_mul(f as Weight))
