...
//! DATE: 2023-02-22, STEPS: `8`, REPEAT: 8, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> crate::WeightInfo for WeightInfo<T> {
	...
	fn migration_v7(t: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_200_000 as u64)
			// Standard Error: 32_290
			.saturating_add(Weight::from_ref_time(13_561_961 as u64).saturating_mul(t as u64))
	...
	// Storage: TaskScheduler Authorities (r:0 w:146)
	/// The range of component `t` is `[0, 1024]`.
	fn migration_v8(t: u32, ) -> Weight {
		// Minimum execution time: 11_600 nanoseconds.
		Weight::from_ref_time(11_900_000 as u64)
			// Standard Error: 45_906
			.saturating_add(Weight::from_ref_time(15_122_985 as u64).saturating_mul(t as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(t as u64)))
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, ) -> Weight {
		// Minimum execution time: 3_277_904 nanoseconds.
		Weight::from_ref_time(3_313_004_000 as u64)
			// Standard Error: 269_829
			.saturating_add(Weight::from_ref_time(7_096_343 as u64).saturating_mul(d as u64))
			// Standard Error: 269_829
			.saturating_add(Weight::from_ref_time(10_711_686 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	...
	fn register_address() -> Weight {
		// Minimum execution time: 92_500 nanoseconds.
		Weight::from_ref_time(95_300_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn claim_legacy_wallet() -> Weight {
		...
		Weight::from_ref_time(76_500_000 as u64)
	...
	fn add_ask_order() -> Weight {
		...
		Weight::from_ref_time(53_100_000 as u64)
	...
	fn add_bid_order() -> Weight {
		...
		Weight::from_ref_time(53_200_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	...
	fn add_offer() -> Weight {
		// Minimum execution time: 58_601 nanoseconds.
		Weight::from_ref_time(59_100_000 as u64)
	...
	fn add_deal_order() -> Weight {
		...
		Weight::from_ref_time(59_900_000 as u64)
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn add_authority() -> Weight {
		...
		Weight::from_ref_time(13_800_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn fail_transfer() -> Weight {
		...
		Weight::from_ref_time(40_200_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Creditcoin DealOrders (r:1 w:1)
	...
	fn lock_deal_order() -> Weight {
		...
		Weight::from_ref_time(37_200_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn register_funding_transfer() -> Weight {
		...
		Weight::from_ref_time(98_100_000 as u64)
	...
	fn register_repayment_transfer() -> Weight {
		// Minimum execution time: 67_900 nanoseconds.
	...
	fn register_funding_transfer_legacy() -> Weight {
		...
		Weight::from_ref_time(66_900_000 as u64)
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Creditcoin DealOrders (r:1 w:1)
	...
	fn close_deal_order() -> Weight {
		// Minimum execution time: 63_600 nanoseconds.
	...
	fn register_deal_order() -> Weight {
		// Minimum execution time: 148_200 nanoseconds.
		Weight::from_ref_time(150_501_000 as u64)
	...
	fn persist_collect_coins() -> Weight {
		// Minimum execution time: 81_800 nanoseconds.
