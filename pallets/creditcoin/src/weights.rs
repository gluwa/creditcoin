...
//! DATE: 2022-11-28, STEPS: `8`, REPEAT: 8, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, u: u32, c: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 24_177_000
			.saturating_add((53_330_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 24_177_000
			.saturating_add((12_865_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 24_177_000
			.saturating_add((35_378_000 as Weight).saturating_mul(o as Weight))
			// Standard Error: 24_177_000
			.saturating_add((105_063_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 24_177_000
			.saturating_add((108_467_000 as Weight).saturating_mul(f as Weight))
			// Standard Error: 24_177_000
			.saturating_add((57_336_000 as Weight).saturating_mul(u as Weight))
			// Standard Error: 24_177_000
			.saturating_add((41_984_000 as Weight).saturating_mul(c as Weight))
