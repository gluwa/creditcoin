...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(a: u32, b: u32, o: u32, d: u32, f: u32, u: u32, c: u32, ) -> Weight {
		(69_958_502_000 as Weight)
			// Standard Error: 22_299_000
			.saturating_add((21_579_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 22_299_000
			.saturating_add((39_343_000 as Weight).saturating_mul(f as Weight))
