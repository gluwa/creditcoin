...
pub mod rpc;
use crate::{
	types::CollectedCoins, Blockchain, Call, Id, Task, TaskOracleData, TaskOutput, Transfer,
...
where
	Moment:
		sp_runtime::traits::UniqueSaturatedInto<u64> + sp_runtime::traits::UniqueSaturatedFrom<u64>,
	BlockNum: sp_runtime::traits::UniqueSaturatedInto<u64>,
{
...
impl crate::types::UnverifiedCollectedCoins {
	...
	pub fn to_output<T: Config>(self, amount: T::Balance) -> CollectedCoins<T::Hash, T::Balance>
	where
		T: Config,
	{
