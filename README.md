...
Follow the steps below to get started with the node.
...
(`cargo build --release && ./target/release/creditcoin-node --dev --ws-external`)
by appending your own. A few useful ones are as follow.

```bash
# Run Substrate node without re-compiling
./scripts/docker_run.sh ./target/release/creditcoin-node --dev --ws-external

# Purge the local dev chain
./scripts/docker_run.sh ./target/release/creditcoin-node purge-chain --dev
