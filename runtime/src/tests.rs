use super::*;
use crate::{Call, ExistentialDeposit, Runtime, System};
...
impl ExtBuilder {
	pub fn build() -> sp_io::TestExternalities {
		...
		pallet_balances::GenesisConfig::<Runtime> {
			balances: vec![(generate_account("Somebody"), existential_deposit())],
		}
